function submit_form() {
  ...
  if (typeof total_experience_needed === 'string') {
    ...
    if (exp_per_hour > 0) {
      ...
      let finished_time_string = (new Date(Date.now() + (total_seconds_needed * 1000))).toLocaleString(undefined, { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric', hour: '2-digit', minute: '2-digit', second:'2-digit' });
