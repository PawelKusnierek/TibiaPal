...
var charm_description_dict = {
    ...
    "carnage": 'Killing a monster has 10/20/22% chance to deal Physical Damage equal to 15% of its maximum health to monsters in a small radius.',
    ...
    "wound": 'Triggers on a creature with a certain chance (5/10/11%) and deals 5% of its max hit points as Physical Damage.',
    "poison": 'Triggers on a creature with a certain chance (5/10/11%) and deals 5% of its max hit points as Earth Damage.',
    "freeze": 'Triggers on a creature with a certain chance (5/10/11%) and deals 5% of its max hit points as Ice Damage.',
    "zap": 'Triggers on a creature with a certain chance (5/10/11%) and deals 5% of its max hit points as Energy Damage.',
    "curse": 'Triggers on a creature with a certain chance (5/10/11%) and deals 5% of its max hit points as Death Damage.',
    "enflame": 'Triggers on a creature with a certain chance (5/10/11%) and deals 5% of its max hit points as Fire Damage.',
    "divine_wrath": 'Triggers on a creature with a certain chance (5/10/11%) and deals 5% of its max hit points as Holy Damage.',
    ...
    "adrenaline_burst": 'After you get hit, enhance your reflexes with a certain chance (6/9/12%) and move faster for 10 seconds.',
    "cleanse": 'Removes one random negative status effect after you get hit (6/9/12% chance) and makes you temporarily immune to it.',
