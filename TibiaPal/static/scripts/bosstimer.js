var questList = [{
    ...
    bosses: [{name: "Urmahlullu", hours: 20}, {name: "Scarlett", hours: 20}, {name: "Oberon", hours: 20}, {name: "Drume", hours: 20}, {
        name: "Mini Arena",
        hours: 20
    }, {name: "Final Arena", hours: 20}, {name: "Graves", hours: 20}, {name: "Zelos", hours: 20}, {name: "Mini Vengoth", hours: 20}, {
        name: "Final Vengoth",
        hours: 20
    }, {name: "Faceless Bane", hours: 20}, {name: "Brokul", hours: 20}, {name: "Leiden", hours: 20}, {name: "Lion Bosses", hours: 20}, {
        name: "Were Bosses",
        hours: 20
    }, {name: "Golds", hours: 20}, {name: "Golds Final", hours: 336}, {name: "Feru Final", hours: 336},],
}, {
    name: "Forgotten Knowledge",
    bosses: [{name: "Lady Tenebris", hours: 20}, {name: "Lloyd", hours: 20}, {
        name: "The Enraged Thorn Knight",
        hours: 20
    }, {name: "Soul of Dragonking Zyrtarch", hours: 20}, {name: "Melting Frozen Horror", hours: 20}, {
        name: "The Time Guardian",
        hours: 20
    }, {name: "The Last Lore Keeper", hours: 336},],
}, {
    name: "Pirat Bosses", bosses: [{name: "Tentugly", hours: 20}, {name: "Ratmiral", hours: 20},],
}, {
    name: "Warzones",
    bosses: [{name: "Warzone 1", hours: 20}, {name: "Warzone 2", hours: 20}, {name: "Warzone 3", hours: 20}, {name: "Warzone 4", hours: 4}, {
        name: "Warzone 5",
        hours: 4
    }, {name: "Warzone 6", hours: 4}, {name: "The Brainstealer", hours: 20},],
}, {
    name: "Issavi Mini", bosses: [{name: "Amenef The Burning", hours: 20}, {name: "Neferi The Spy", hours: 20}, {name: "Sister Hetai", hours: 20},],
}, {
    name: "Ferumbras Mini",
    bosses: [{name: "Mazoran", hours: 48}, {name: "Plagirath", hours: 48}, {name: "Ragiaz", hours: 48}, {name: "Razzagorn", hours: 48}, {
        name: "Shulgrax",
        hours: 48
    }, {name: "Tarbaz", hours: 48}, {name: "Zamulosh", hours: 48},],
}, {
    name: "Secret Library",
    bosses: [{name: "Lokathmor", hours: 20}, {name: "Mazzinor", hours: 20}, {name: "Gorzindel", hours: 20}, {
        name: "Ghulosh",
        hours: 20
    }, {name: "The Scourge Of Oblivion", hours: 20},],
}, {
    name: "Cults of Tibia",
    bosses: [{name: "Essence Of Malice", hours: 20}, {name: "The Armored Voidborn", hours: 20}, {name: "The False God", hours: 20}, {
        name: "The Sandking",
        hours: 20
    }, {name: "The Souldespoiler", hours: 20}, {name: "The Source Of Corruption", hours: 20},],
}, {
    name: "Feaster of Souls",
    bosses: [{name: "Brain Head", hours: 20}, {name: "Unaz The Mean", hours: 20}, {name: "Irgix The Flimsy", hours: 20}, {
        name: "Vok The Freakish",
        hours: 20
    },],
}, {
    name: "Opticording Sphere", bosses: [{name: "Last Planegazer", hours: 168}, {name: "Planestrider", hours: 20},],
}, {
    name: "Misc", bosses: [{name: "Kroazur", hours: 2}, {name: "Oramond", minutes: 16, seconds: 40},],
},];
...
function init() {
    ...
    questList.forEach(function (quest) {
        ...
        quest.bosses.forEach(function (boss) {
            ...
            var img = new Image();
            img.src = "../static/images/bosses/" + nameUnderscore(boss.name) + ".gif";
...
function setCookieBoss(name, value, hours) {
    ...
    document.cookie = profile_name + "=" + (value || "") + expires + "; path=/; SameSite=Strict; max-age=31536000;";
}
