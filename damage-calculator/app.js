...
function initializePlannerFrames(build) {
  ...
  setPlannerFrameSrc(document.querySelector("#proficiencyPlannerFrame"), plannerUrl("/weapon-proficiency.html", { embed: "damage", v: "20260918-1", vocation: build.state.stats.vocation, build: build.state.proficiencyPlanner.token }));
}
